...
export const ITEMS = {
  TRACE_RUNE:
    ...
    EFFECT_RAISE_A_SHIELD: 'Compendium.pf2e.equipment-effects.Item.2YgXoHvJfrDHucMr',
    EFFECT_HOLTRICK_RUNE_OF_DWARVEN_RAMPARTS: 'Compendium.pf2e-runesmith-assistant.pf2e-runesmith-assistant-items.Item.gBwMb0QqrBJVzyYc'
};
